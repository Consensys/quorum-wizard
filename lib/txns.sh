...
do
  ...
  docker exec node${NODE} geth --exec "loadScript('scripts/public_generate_events.js')" attach qdata/dd/geth.ipc
  # docker exec node${NODE} geth --exec "loadScript('scripts/private_generate_events.js')" attach qdata/dd/geth.ipc
